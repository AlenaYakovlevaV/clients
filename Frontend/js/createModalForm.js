...
export const createClients = () => {
    ...
    cancelBtn.addEventListener('click', () => {document.querySelector('.modal-active').remove()});

    // Событие добавления контакта клиента
    ...
    addContactBtn.addEventListener('mousemove', () => {
        addContactBtnSvgDefault.classList.remove('btn-contact__svg--active'); 
        addContactBtnSvgHover.classList.add('btn-contact__svg--active'); 
    });

    addContactBtn.addEventListener('mouseleave', () => {
        addContactBtnSvgDefault.classList.add('btn-contact__svg--active'); 
        addContactBtnSvgHover.classList.remove('btn-contact__svg--active'); 
    });
